...
class ServiceController extends Controller
{
        ...
        try {
            if ($model->load($_POST)) {
                ...
                if ($gbr != NULL) {
                    ...
                    $path = \Yii::getAlias("@frontend/web/uploads/service/") . $model->gambar;
                    $gbr->saveAs($path);
                }
                if ($gbr == NULL) {
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load($_POST)) {
            ...
            if ($model->save()) {
                \Yii::$app->session->addFlash("success", "Service & Layanan successfully updated.");
            } else {
                \Yii::$app->session->addFlash("danger", "Service & Layanan cannot updated.");
            }
            return $this->redirect(['view', 'id' => $model->id]);
        }
