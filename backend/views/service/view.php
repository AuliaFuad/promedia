...
<div class="giiant-crud service-view">
    ...
    <p class="pull-right">
        <?= Html::a('<span class="glyphicon glyphicon-list"></span> ' . Yii::t('cruds', 'Daftar Service'), ['index'], ['class'=>'btn btn-default']) ?>
    </p>
    ...
    <div class="box box-info">
        <div class="box-body">
            <?php $this->beginBlock('backend\models\Service'); ?>
            ...
            <?= DetailView::widget([
                ...
                'attributes' => [
                    ...
                    [
                        'format' => 'html',
                        'attribute' => 'gambar',
                        'value' => '<img src="'.Yii::$app->urlManagerService->baseUrl."/".'' . $model->gambar . '"></span>'
            ...
            <?= Tabs::widget(
                [
                    ...
                    'items' => [ [
                        ...
                        'content' => $this->blocks['backend\models\Service'],
                        'active'  => true,
                    ], ]
                ]
            );
