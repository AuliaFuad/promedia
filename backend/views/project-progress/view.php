...
$this->title = 'Project Progress ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => 'Project Progress', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => (string)$model->id, 'url' => ['view', 'id' => $model->id]];
$this->params['breadcrumbs'][] = Yii::t('cruds', 'View');
?>
<div class="giiant-crud project-progress-view">
    ...
    <p class="pull-right">
        <?= Html::a('<span class="glyphicon glyphicon-list"></span> ' . Yii::t('cruds', 'Daftar Project Progress'), ['index'], ['class'=>'btn btn-default']) ?>
    </p>
    ...
    <div class="box box-info">
        <div class="box-body">
            <?php $this->beginBlock('backend\models\ProjectProgress'); ?>
...
[
    ...
    'value' => ($model->getIdProject()->one()->judul)
],
        [
                        'format' => 'html',
                        'attribute' => 'gambar',
    ...
    'content' => $this->blocks['backend\models\ProjectProgress'],
    'active'  => true,
], ]
                 ]
    );
