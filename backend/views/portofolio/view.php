...
$this->title = 'Portofolio ' . $model->id;
...
<div class="giiant-crud portofolio-view">
    ...
    <p class="pull-right">
        <?= Html::a('<span class="glyphicon glyphicon-list"></span> ' . Yii::t('cruds', 'Daftar Portofolio'), ['index'], ['class'=>'btn btn-default']) ?>
    </p>
    ...
    <div class="box box-info">
        <div class="box-body">
            <?php $this->beginBlock('backend\models\Portofolio'); ?>
            ...
            <?= DetailView::widget([
                ...
                'attributes' => [
                    ...
                    [
                        'format' => 'html',
                        'attribute' => 'gambar',
                        'value' => '<img width="370" height="270" src="'.Yii::$app->urlManagerPortofolio->baseUrl."/".'' . $model->gambar . '"></span>'
            ...
            <?= Tabs::widget(
                [
                    ...
                    'items' => [ [
                        ...
                        'content' => $this->blocks['backend\models\Portofolio'],
                        'active'  => true,
                    ], ]
                ]
            );
