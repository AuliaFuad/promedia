...
$this->title = 'Usaha ' . $model->nama_usaha;
$this->params['breadcrumbs'][] = ['label' => 'Usaha', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => (string)$model->nama_usaha, 'url' => ['view', 'id' => $model->id]];
$this->params['breadcrumbs'][] = Yii::t('cruds', 'View');
?>
<div class="giiant-crud usaha-view">
    ...
    <p class="pull-right">
        <?= Html::a('<span class="glyphicon glyphicon-list"></span> ' . Yii::t('cruds', 'Daftar Usaha'), ['index'], ['class' => 'btn btn-default']) ?>
    </p>
    ...
    <div class="box box-info">
        <div class="box-body">
            <?php $this->beginBlock('backend\models\Usaha'); ?>
            ...
            <div style='position: relative'>
                <div style='position:absolute; right: 0px; top 0px;'>
                    ...
                    <?= Html::a(
                        ...
                        ['perusahaan-satu/create', 'PerusahaanSatus' => ['id_usaha' => $model->id]],
                ...
                'columns' => [
                    [
                        ...
                        'urlCreator' => function ($action, $model, $key, $index) {
                            ...
                            $params['PerusahaanSatu'] = ['id_usaha' => $model->primaryKey()[0]];
                            return $params;
                        },
                        'buttons' => [
                    ...
                    [
                        ...
                        'value' => function ($model) {
                            if ($rel = $model->getIdBisnis()->one()) {
                                return Html::a($rel->id, ['bisnis/view', 'id' => $rel->id,], ['data-pjax' => 0]);
                            } else {
                                return '';
                            }
                        },
            ...
            <?= Tabs::widget(
                [
                    ...
                    'items' => [[
                        ...
                        'content' => $this->blocks['backend\models\Usaha'],
                        'active' => true,
                    ], [
